...
function transport (fullOptions) {
  ...
  if (targets) {
    target = bundlerOverrides['plno-logger-worker'] || join(__dirname, 'worker.js')
  ...
  const name = (targets || pipeline) ? 'plno-logger.transport' : target
  ...
  function fixTarget (origin) {
    ...
    if (origin === 'plno-logger/file' || origin === 'plno/file' || origin === 'pinoex/file' || origin === 'pinox/file' || origin === 'pino/file') {
